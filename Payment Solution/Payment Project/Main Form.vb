...
' Programmer:   Zachary Murphy on 3-17-2017
...
Public Class frmMain
    ...
    Private Sub frmMain_Load(sender As Object, e As EventArgs) Handles Me.Load
        ' fill combo box with rates and select first rate
    ...
    Private Sub ClearPayment(sender As Object, e As EventArgs) Handles txtPrincipal.TextChanged, cboRates.TextChanged
        lblPay.Text = String.Empty
    End Sub
